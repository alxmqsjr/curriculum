...
$wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'cr_color_award', array(
...
$wp_customize->add_control('cr_awards_icon', array(
	...
	'section' => 'cr_config_awards', 
	'type' => 'text',
	'input_attrs' => array ('placeholder' => __('ex: fas fa-ad'), 'style' => 'margin-bottom:30px')
));
