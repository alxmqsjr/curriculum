<?php
	...
	$wp_customize->add_control( 'cr_font', array(
			...
			'type' => 'textarea',
			'input_attrs' => array (
				'placeholder' => __('ex: <style>@import url("https://fonts.googleapis.com/css2?family=Open+Sans:wght@300&display=swap");</style>')	
			)
    ));
	...
	$wp_customize->add_control( 
		new WP_Customize_Color_Control($wp_customize, 'cr_color', array(
	...
	$wp_customize->add_control( 
		new WP_Customize_Color_Control($wp_customize, 'cr_color_menu', array(
	...
	$wp_customize->add_control( 
		new WP_Customize_Color_Control($wp_customize, 'cr_color_menu_hover', array(
